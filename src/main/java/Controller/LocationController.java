...
public class LocationController {
    public Boolean addLocation(String name, String address, int publicLocation) {
        if(publicLocation == 1 || publicLocation == 2){
            Database.currentLoggedInOrganizer.addLocation(new Model.Location(name, address, (publicLocation==1)));
